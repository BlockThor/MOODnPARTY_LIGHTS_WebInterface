...
oninput="onColor(event, this.value, '0')">
</div>
<div class='flex-col'>
...
oninput="onColor(event, this.value, '2')">
</div>
<div class='flex-col'>
<div class='flex-row' style="width: 280px">
<label class='txt' for="color1">Background:</label>
<input type="color" id="color1"  oninput="onColor(event, this.value, '1')">
...
<div class="form">
  ...
  <input type="time" id="time-in" value="06:30"  onchange="sendTimers()">
  </span>
...
<div class='flex-row'>
<div class='flex-col'>
  <div class="form"><h4>Now you are connected:</h4><div id="WR"></div>
</div>
</div>
<div class='flex-col'>
...
<input type="number" id="SN" name="sn" value='10' min='5' max="1024" onchange="sendVal(event, this)">
</span>
<span class="txt">Port pin
<input type="number" id="SP" name="sp" value='4' min='0' max='16' onchange="sendVal(event, this)">
</span>
